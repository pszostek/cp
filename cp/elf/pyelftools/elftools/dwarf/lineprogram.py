...
#
class LineProgramEntry(object):
    'LineProgramEntry(command, is_extended, args, state)'
    def __init__(self, command, is_extended, args, state):
    ...
    def __repr__(self):
        ...
        return 'LineProgramEntry(command=0x%x' % self.command + ', is_extended=%r, args=%r, state=%r)' % (self.is_extended, self.args, self.state)
